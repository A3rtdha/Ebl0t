"""
voice_time.py — учёт времени в голосовых каналах по серверу (JSON).
"""
...
_STATS_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "voice_stats.json")
_ACTIVE_PATH = os.path.join(os.path.dirname(__file__), "..", "data", "voice_active.json")
