import disnake
from modules.valorant.services.match_outcome import (
    SCORE_PRESETS,
    apply_team_outcome,
...
def _result_flow_busy(channel_id: int) -> bool:
    from modules.valorant.services import result_flow_state
    return result_flow_state.is_channel_busy(channel_id)
...
class MatchOutcomeView(disnake.ui.View):
    ...
    async def confirm(self, button: disnake.ui.Button, inter: disnake.MessageInteraction):
        ...
        from modules.valorant.services.result_flow import start_result_flow

        await start_result_flow(
